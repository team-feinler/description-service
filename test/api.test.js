...
describe('API Endpoints', () => {
  describe('/description/:productId Endpoint', () => {
    test('/description/:productId endpoint will respond with 200 if productId is between 1000-1100', async (done) => {
  ...
  describe('/description/multiple Endpoint', () => {
    ...
    test('/description/multiple endpoint will respond with 200 if array of productIds between 1000-1100 are sent', async (done) => {
